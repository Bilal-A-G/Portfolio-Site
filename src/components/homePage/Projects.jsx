...
const Projects = () => {
    return(
        <div className="w-full bg-black md:pb-[20%] pb-[25%] text-white">
            ...
            <div className="w-full lg:gap-[8%] gap-y-[10%] items-center mt-[4%] grid place-items-center justify-center flex md:grid-cols-2 lg:grid-cols-3 auto-rows-max md:grid-flow-cols">
