...
const Home = () => {
    return(
      <div className="w-full h-full">
              <Hero/>
              <ImageTextRow id={"about"} image={`bg-[url(${Resources.ProfilePicture})]`} title="About Me" subtitle="Here's a little bit" leftAlign={true} sphere={true} extras={
                  <div className="text-black">
                      ...
                      <div className="flex w-full md:pl-[0%] pl-[25%] md:pt-[5%] pt-[10%] pb-[15%] grid place-items-center auto-cols-max grid-flow-col gap-[2%]">
                          <div className='h-[40px] w-[40px] md:h-[20px] md:w-[20px] lg:h-[30px] lg:w-[30px] 2xl:h-[50px] 2xl:w-[50px] bg-[url("CSharp.svg")] bg-cover bg-center'/>
                          <div className='h-[40px] w-[40px] md:h-[20px] md:w-[20px] lg:h-[30px] lg:w-[30px] 2xl:h-[50px] 2xl:w-[50px] bg-[url("CPlusPlus.svg")] bg-cover bg-center'/>
                          <div className='h-[40px] w-[40px] md:h-[20px] md:w-[20px] lg:h-[30px] lg:w-[30px] 2xl:h-[50px] 2xl:w-[50px] bg-[url("OpenGL.svg")] bg-cover bg-center'/>
